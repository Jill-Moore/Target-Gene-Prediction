...
def Create_Feature_Array(data, enhancerSignals, tssSignals, distanceDict, geneDict):
    labels=[]
    features=[]
    for pair in data:
        tssFeatures=[]
        ...
        features.append(distanceDict[pair[0]+"-"+pair[1]]+enhancerSignals[pair[0]]+tssFeatures)
